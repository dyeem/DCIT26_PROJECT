...
export default function FeaturedVidComponent() {
    return (
        <>
            <div className="flex flex-col max-w-full justify-center items-center px-5 py-8 bg-white lg:gap-y-4">
                <div className="flex flex-col justify-center lg:items-center xsm:items-start leading-relaxed -tracking-normal lg:text-center xsm:text-left lg:gap-y-7 xsm:gap-y-4 mb-10">
                    ...
                    <Link
                        to="sales"
                        className="bg-[#885b56] hover:bg-[#b8817b] text-white px-4 py-2 rounded-3xl text-lg"
                    >
                        Shop Crochet
                    </Link>
                </div>
                <video
                    ...
                    loop
                    muted
                    className="w-full rounded-md lg:w-[100rem] lg:h-auto xsm:h-[400px] object-cover"
                />
            </div>
        </>
    );

...
import { Package, Calendar, DollarSign, Truck, CheckCircle, Clock, XCircle, Eye, MapPin, Phone } from 'lucide-react'
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                        <div>
                                            ...
                                            <div className="space-y-2 text-sm">
                                                <p><span className="text-gray-600">Order Date:</span> {formatDate(selectedOrder.created_at)}</p>
                                                <p><span className="text-gray-600">Total Amount:</span> {formatPrice(selectedOrder.total_amount)}</p>
                                                <p><span className="text-gray-600">Payment Method:</span> {selectedOrder.payment_method || 'N/A'}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-2 text-sm">
                                                <div className="flex items-start gap-2">
                                                    ...
                                                    <span className="text-gray-600">Address:</span> <p>{selectedOrder.shipping_address || 'N/A'}</p>
                                                <p><span className="text-gray-600">City:</span> {selectedOrder.shipping_city || 'N/A'}</p>
                                                <p><span className="text-gray-600">Phone:</span> {selectedOrder.phone || 'N/A'}</p>
                                            </div>
                                        </div>
                                    </div>

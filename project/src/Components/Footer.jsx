        ...
        <>
            <footer className="border-base-300 border-t footer bg-base-200 text-base-content p-10 grid grid-cols-1 lg:grid-cols-3 ">
                <nav className="justify-self-center justify-items-center">
                    ...
                    <a className="text-sm leading-relaxed text-[1rem]">Branding</a>
                    <a className="text-sm leading-relaxed text-[1rem]">Design</a>
                    <a className="text-sm leading-relaxed text-[1rem]">Marketing</a>
                    <a className="text-sm leading-relaxed text-[1rem]">Advertisement</a>
                </nav>
                <nav className="justify-self-center justify-items-center">
                    ...
                    <a className="text-sm leading-relaxed text-[1rem]">About us</a>
                    <a className="text-sm leading-relaxed text-[1rem]">Contact us</a>
                    <a className="text-sm leading-relaxed text-[1rem]">FAQ</a>
                    <a className="text-sm leading-relaxed text-[1rem]">Reviews</a>
                </nav>
                <nav className="justify-self-center justify-items-center">
                    <h6 className="footer-title font-serif text-xl lg:text-2xl relative group">Legal
                        <span 
                            className="absolute bottom-0 left-0 h-[2px] w-0 bg-slate-100 transition-all duration-300 group-hover:w-full"
                        />
                    </h6>
                    <a className="text-sm leading-relaxed text-[1rem]">Terms of use</a>
                    <a className="text-sm leading-relaxed text-[1rem]">Privacy policy</a>
                    <a className="text-sm leading-relaxed text-[1rem]">Cookie policy</a>
                </nav>
            </footer>
